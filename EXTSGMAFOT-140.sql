...
Insert into RULVALUE (RULID,RVAORDRE,RVAVALUE,RULIDVALUE,CRIID) values ('3007153','1',null,'300751',null);---sogec
...
Insert into RULVALUE (RULID,RVAORDRE,RVAVALUE,RULIDVALUE,CRIID) values ('3007156','1',null,'3007152',null);---ccpro
...
Insert into RULVALUE (RULID,RVAORDRE,RVAVALUE,RULIDVALUE,CRIID) values ('3007149','3',null,'3007156',null);
Insert into RULVALUE (RULID,RVAORDRE,RVAVALUE,RULIDVALUE,CRIID) values ('3007149','4',null,'3007148',null);
...
Insert into RULE (RULID,RULCODE,RULTARGET,RULOPERATOR,RULLOWERLIMIT,RULUPPERLIMIT,RULSTATUS,CRIIDFIRST,RULIDFIRST,RULIDSECOND,CRIIDSECONDMAX,CRIIDSECONDMIN,RULTYPE,RULFLAGCASSIOPAE,RULGROUP) 
values ('3007163','SGMAPRO','AVDOSS','IN',null,null,'ACTIVE','4',null,null,null,null,'LOGICAL',null,null);

---- LANRULE
Insert into LANRULE (RULID,LANCODE,RULLABEL) values ('3007163','FR','Bareme SGMA CLIPRO');


Insert into RULVALUE (RULID,RVAORDRE,RVAVALUE,RULIDVALUE,CRIID) values ('3007163','1',null,'3007156',null);---CLIPRO and ca inf 10M
Insert into RULVALUE (RULID,RVAORDRE,RVAVALUE,RULIDVALUE,CRIID) values ('3007163','2',null,'3007148',null);--- COMSGL

delete  from lkpcrrul where pcrid =10 ;
Insert into LKPCRRUL (PCRID,PCRORDRE,RULID,PRUDTSTART,PRUDTEND,PRUFLAGFORCING) values ('10','1','3007163',to_date('01/01/20','DD/MM/RR'),null,null);
...
Insert into RULE (RULID,RULCODE,RULTARGET,RULOPERATOR,RULLOWERLIMIT,RULUPPERLIMIT,RULSTATUS,CRIIDFIRST,RULIDFIRST,RULIDSECOND,CRIIDSECONDMAX,CRIIDSECONDMIN,RULTYPE,RULFLAGCASSIOPAE,RULGROUP) 
values ('3007164','SGMACOM','AVDOSS','IN',null,null,'ACTIVE','4',null,null,null,null,'LOGICAL',null,null);

---- LANRULE
Insert into LANRULE (RULID,LANCODE,RULLABEL) values ('3007164','FR','Bareme SGMA CLICOM');


Insert into RULVALUE (RULID,RVAORDRE,RVAVALUE,RULIDVALUE,CRIID) values ('3007164','1',null,'3007160',null);---CLIcomand ca sup 10M
Insert into RULVALUE (RULID,RVAORDRE,RVAVALUE,RULIDVALUE,CRIID) values ('3007164','2',null,'3007148',null);--- COMSGL

delete  from lkpcrrul where pcrid =12 ;
Insert into LKPCRRUL (PCRID,PCRORDRE,RULID,PRUDTSTART,PRUDTEND,PRUFLAGFORCING) values ('12','1','3007164',to_date('01/01/20','DD/MM/RR'),null,null);




---------- pcrid =16  ;--Barème standard Sogecontact, vendors et SGMA CLIPRO : Leasing immobilier

---sogec et clipro et ca inf 10M et comsgl

---big rule 

Insert into RULE (RULID,RULCODE,RULTARGET,RULOPERATOR,RULLOWERLIMIT,RULUPPERLIMIT,RULSTATUS,CRIIDFIRST,RULIDFIRST,RULIDSECOND,CRIIDSECONDMAX,CRIIDSECONDMIN,RULTYPE,RULFLAGCASSIOPAE,RULGROUP) 
values ('3007165','RLSGIM','AVDOSS','IN',null,null,'ACTIVE','4',null,null,null,null,'LOGICAL',null,null);

---- LANRULE
Insert into LANRULE (RULID,LANCODE,RULLABEL) values ('3007165','FR','Bareme SGMA CBI CLI');


Insert into RULVALUE (RULID,RVAORDRE,RVAVALUE,RULIDVALUE,CRIID) values ('3007165','1',null,'3007156',null);--  clipro et ca inf 
Insert into RULVALUE (RULID,RVAORDRE,RVAVALUE,RULIDVALUE,CRIID) values ('3007165','2',null,'3007153',null);--- sogec et ca inf 
Insert into RULVALUE (RULID,RVAORDRE,RVAVALUE,RULIDVALUE,CRIID) values ('3007165','3',null,'3007148',null);--- COMSGL


delete from lkpcrrul where pcrid =16 ;
Insert into LKPCRRUL (PCRID,PCRORDRE,RULID,PRUDTSTART,PRUDTEND,PRUFLAGFORCING) values ('16','1','3007165',to_date('01/01/20','DD/MM/RR'),null,null);

-------pcrid =20  ;---Barème standard Sogecontact, vendors et SGMA CLICOM : Leasing immobilier
---sogec et clicom et ca sup 10M et comsgl

--big rule 

Insert into RULE (RULID,RULCODE,RULTARGET,RULOPERATOR,RULLOWERLIMIT,RULUPPERLIMIT,RULSTATUS,CRIIDFIRST,RULIDFIRST,RULIDSECOND,CRIIDSECONDMAX,CRIIDSECONDMIN,RULTYPE,RULFLAGCASSIOPAE,RULGROUP) 
values ('3007166','RLSGICOM','AVDOSS','IN',null,null,'ACTIVE','4',null,null,null,null,'LOGICAL',null,null);

---- LANRULE
Insert into LANRULE (RULID,LANCODE,RULLABEL) values ('3007166','FR','Bareme SGMA CBI CLICOM');


Insert into RULVALUE (RULID,RVAORDRE,RVAVALUE,RULIDVALUE,CRIID) values ('3007166','1',null,'3007160',null);--  clicom et ca sup 
Insert into RULVALUE (RULID,RVAORDRE,RVAVALUE,RULIDVALUE,CRIID) values ('3007166','2',null,'3007158',null);--- sogec et ca sup
Insert into RULVALUE (RULID,RVAORDRE,RVAVALUE,RULIDVALUE,CRIID) values ('3007166','3',null,'3007148',null);--- COMSGL



delete from lkpcrrul where pcrid =20 ;
Insert into LKPCRRUL (PCRID,PCRORDRE,RULID,PRUDTSTART,PRUDTEND,PRUFLAGFORCING) values ('20','1','3007166',to_date('01/01/20','DD/MM/RR'),null,null);

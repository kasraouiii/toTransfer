CREATE OR REPLACE PACKAGE TRSGM45.PAV4_PASSWORD
AS
    ...
    PROCEDURE U_LOGOFFTIME (sUTICODE      IN     USERACTIVITY.UACUTICODE%TYPE,
                            nReturnCode   IN OUT NUMBER);
...
------------------------------------BODY----------------------------
/
CREATE OR REPLACE PACKAGE BODY TRSGM45.PAV4_PASSWORD
AS
    ...
    BEGIN
        ...
        -- Added as part of SOGELEASE-166, This will fetch value from TOPPARAM and set it in UTIPWDHASHALGORITHM column of UTILISATEUR table to indicate which algo is used during hashing of password
        BEGIN
